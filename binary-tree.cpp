...
int main()
{
    BiTree T;
    //测试数据AB#CD##E##F#GH###
    cout << "Priority traversal of inputs(End with #):";
    CreateBiTree(T);
    cout << "Middle order traversal output:";
    InOrderTraverse(T);
    cout << endl
         << "Precedence traversal output:";
    PreOrderTraverse(T);
    cout << "\n"
         << "Posterior order traversal output:";
    PostOrderTraverse(T);
    cout << endl
         << "Depth of the tree:" << Depth(T);
    cout << endl
         << "Number of nodes:" << NodeCount(T);
    cout << endl
         << "All paths from each leaf node to the root node in a binary tree:" << endl;
    char path[256];
    int pathlen = 0;
